...
port (
    ...
    outcount41_dout : IN STD_LOGIC_VECTOR (31 downto 0);
    outcount41_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
    outcount41_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    outcount41_empty_n : IN STD_LOGIC;
    outcount41_read : OUT STD_LOGIC;
...
attribute shreg_extract : string;
    ...
    signal tmp_reg_143 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_start : STD_LOGIC;
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_done : STD_LOGIC;
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_idle : STD_LOGIC;
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_ready : STD_LOGIC;
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outbuf_read : STD_LOGIC;
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TVALID : STD_LOGIC;
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TREADY : STD_LOGIC;
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TUSER : STD_LOGIC_VECTOR (6 downto 0);
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_p_phi_out : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_p_phi_out_ap_vld : STD_LOGIC;
    signal grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal p_phi_loc_fu_66 : STD_LOGIC_VECTOR (0 downto 0);
    signal out_val_last_V_fu_62 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_phi_loc_load_load_fu_112_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal regslice_both_outStreamTop_V_data_V_U_apdone_blk : STD_LOGIC;
    signal ap_block_state1 : BOOLEAN;
    signal xor_ln135_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component userdma_sendoutstream_Pipeline_VITIS_LOOP_125_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89 : component userdma_sendoutstream_Pipeline_VITIS_LOOP_125_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0) and (p_phi_loc_load_load_fu_112_p1 = ap_const_lv1_1))) then 
    ...
    grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                    grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_ready = ap_const_logic_1)) then 
                    grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0) and (p_phi_loc_load_load_fu_112_p1 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_p_phi_out_ap_vld = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, outcount41_empty_n, in_en_clrsts_empty_n, ap_CS_fsm_state2, grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_done, ap_CS_fsm_state4, p_phi_loc_load_load_fu_112_p1, ap_CS_fsm_state5, regslice_both_outStreamTop_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((in_en_clrsts_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (((outcount41_empty_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
            ...
            when ap_ST_fsm_state5 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0) and (p_phi_loc_load_load_fu_112_p1 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0) and (p_phi_loc_load_load_fu_112_p1 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state5;
                end if;
    ...
    begin
        if (((in_en_clrsts_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) then 
    ...
    ap_ST_fsm_state2_blk_assign_proc : process(outcount41_empty_n)
    begin
        if ((outcount41_empty_n = ap_const_logic_0)) then 
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_done)
    begin
        if ((grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_done = ap_const_logic_0)) then 
    ...
    begin
                ap_block_state1 <= ((in_en_clrsts_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, p_phi_loc_load_load_fu_112_p1, ap_CS_fsm_state5, regslice_both_outStreamTop_V_data_V_U_apdone_blk)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0) and (p_phi_loc_load_load_fu_112_p1 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(p_phi_loc_load_load_fu_112_p1, ap_CS_fsm_state5, regslice_both_outStreamTop_V_data_V_U_apdone_blk)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0) and (p_phi_loc_load_load_fu_112_p1 = ap_const_lv1_1))) then 
    ...
    grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_start <= grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_ap_start_reg;
    grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TREADY <= (outStreamTop_TREADY_int_regslice and ap_CS_fsm_state4);
    ...
    m2s_buf_sts_assign_proc : process(p_phi_loc_load_load_fu_112_p1, ap_CS_fsm_state5, regslice_both_outStreamTop_V_data_V_U_apdone_blk, xor_ln135_fu_120_p2, m2s_buf_sts_preg)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0) and (p_phi_loc_load_load_fu_112_p1 = ap_const_lv1_1))) then 
    ...
    m2s_buf_sts_ap_vld_assign_proc : process(p_phi_loc_load_load_fu_112_p1, ap_CS_fsm_state5, regslice_both_outStreamTop_V_data_V_U_apdone_blk)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state5) and (regslice_both_outStreamTop_V_data_V_U_apdone_blk = ap_const_logic_0) and (p_phi_loc_load_load_fu_112_p1 = ap_const_lv1_1))) then 
    ...
    outStreamTop_TVALID_int_regslice <= grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outStreamTop_TVALID;

    outbuf_read_assign_proc : process(grp_sendoutstream_Pipeline_VITIS_LOOP_125_2_fu_89_outbuf_read, ap_CS_fsm_state4)
    begin
    ...
    outcount41_blk_n_assign_proc : process(outcount41_empty_n, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    outcount41_read_assign_proc : process(outcount41_empty_n, ap_CS_fsm_state2)
    begin
        if (((outcount41_empty_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            outcount41_read <= ap_const_logic_1;
        else 
            outcount41_read <= ap_const_logic_0;
        end if; 
    end process;

    p_phi_loc_load_load_fu_112_p1 <= p_phi_loc_fu_66;
    xor_ln135_fu_120_p2 <= (in_en_clrsts_read_reg_138 xor ap_const_lv1_1);
end behav;
